...
output_dir = 'pages_Bulletin'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

images = convert_from_path('Bulletin.pdf')
...
import cv2
image = cv2.imread("pages_Bulletin/page2.jpg")
image = image[..., ::-1]
...
im = cv2.imread('pages_Bulletin/page2.jpg')
...
pd.DataFrame(out_array).to_excel('tables/Bulletin_page3.xlsx')
