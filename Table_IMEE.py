...
output_dir = 'pages_IMEE'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

images = convert_from_path('IMEE.pdf')
...
import cv2
image = cv2.imread("pages_IMEE/page5.jpg")
image = image[..., ::-1]
'''
...
im = cv2.imread('pages_IMEE/page5.jpg')
...
pd.DataFrame(out_array).to_excel('tables/IMEE_page6.xlsx')
