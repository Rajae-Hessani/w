...
import cv2
image = cv2.imread("pages_rapport_ec/page133.jpg")
image = image[..., ::-1]
'''
...
im = cv2.imread('pages_rapport_ec/page133.jpg')
...
pd.DataFrame(out_array).to_excel('tables/table_rapport_ec_page134.xlsx')
