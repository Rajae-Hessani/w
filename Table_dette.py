...
output_dir = 'pages_dette'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

images = convert_from_path('dette.pdf')
...
import cv2
image = cv2.imread("pages_dette/page1.jpg")
image = image[..., ::-1]
...
second_text_block.block.x_2 = 1650
...
im = cv2.imread('pages_dette/page1.jpg')
...
pd.DataFrame(out_array).to_excel('tables/dette_page2.xlsx')
